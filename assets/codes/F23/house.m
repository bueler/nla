...
% HOUSE computes R in reduced QR decomposition A = QR.  Applies
% Householder triangularization, Trefethen & Bau Algorithm 10.1.
% Also returns vectors "v" in a matrix W which can be used to
% recover Q.  See also FORMQ.
% Usage:
%   >> [W,R] = house(A)
% Here W is lower triangular and R is upper triangular.  Do
%   >> Q = formQ(W)
% to get factor Q if desired.

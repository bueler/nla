function showmat(A);
% SHOWMAT  Picture action of a real 2x2 matrix A using singular values
% and left/right singular vectors.
% Examples:  >> showmat(randn(2,2))
...
[U,S,V] = svd(A);                % get the SVD factors
...
text(1.6, .25, 'A'),  text(1.5, 0, '--->')  % arrow

...
\noindent for \due{Homework} due dates and \ee{Exam} dates.  Classes are MWF 2:15 -- 3:15pm, Chapman 107.  Homework is due at the start of class.  Textbook lecture numbers are in black.  Note the \dlinline{deadlines}, \vacinline{no class} days, and dates Ed is in Sweden \includegraphics[width=12px]{sweden.png} (when class is remote only).
...
\wkday{3}{9/8}{9/12}     & 3 & \sweol & \vac{class cancelled} \swe \\ \hline

\wkday{4}{9/15}{9/19}    & 4 \par \due{Assignment 2} \sweol & \phantom{x} \swe & 5 \swe\\ \hline

\wkday{5}{9/22}{9/26}    & 6 & 7 & 8 \\ \hline

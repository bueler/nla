...
\begin{document}
\scriptsize \noindent Math 614 Numerical Linear Algebra (Bueler) \hfill \emph{assigned 21 November 2025; {\color{BrickRed} version 2}}
\normalsize\medskip
...
\centerline{\hspace{25mm} \textbf{Due {\color{BrickRed} Monday 8 December at 5:00pm}} \quad {\color{BrickRed} $\leftarrow$ revised!} }
\medskip
\normalsize
